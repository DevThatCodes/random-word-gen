...
fn generate_word(wordlen: i32, max_vowels_in_a_row: i32, max_consonants_in_a_row: i32, consonant_mutation_chance: i32, vowel_mutation_chance: i32) -> (String, String) {
...
fn main() {
    ...
    let consonant_mutation_chance = 3; // chance for something to become a consonant ( 1 in ? )
    let vowel_mutation_chance = 2; // chance for something to become a vowel ( 1 in ? )
